...
window.on('ready', function(){
	...
	var $ = window.$;
	window.onInputDeviceChange = function( inputDeviceCombo ) { onInputDeviceChange( inputDeviceCombo.selectedIndex ); };
	
	this.DSP = require("./AudioHubDSP").createNewAudioHubDSP( IS_CLIENT, "Engine" );
